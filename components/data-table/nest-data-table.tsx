import { dataTableParamsState, totalNestDataTablePageState } from '@/store/param-data'
import { t } from '@/utils'
...
export const NestDataTable = (props: ICustomDataTableProps) => {
  ...
  const totalPage = useRecoilValue(totalNestDataTablePageState)
  const isFirstLoading = useRecoilValue(loadingState)
                    ...
                    {!isFirstLoading && (
                      <TableCell colSpan={colSpanEmpty} align="center">
                        <Stack justifyContent={'center'} height={200}>
                          ...
                          <Typography color={grey[600]}>Dữ liệu không được tìm thấy</Typography>
                        </Stack>
                      </TableCell>
                    )}
                  </TableRow>
